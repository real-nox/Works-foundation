...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      //Owner filter
      let ranox = client.users.cache.get("738748467387564042");
      console.log(ranox.username)
      if (command.ownersOnly) {
        if (
          !client.users.cache.get("738748467387564042")

        ) {
          errEmbed.setDescription(
            "⛔ | Oops! You don't aren't the Owner to use this command!"
          );
      ...
      if (command.moderatorOnly) {
        if (
          !member.roles.cache.has("1115672651759882320") ||
          !member.roles.cache.has("1116831324003643553")

        ) {
          errEmbed.setDescription(
            "⛔ | Oops! You don't have permissions for that! Please contact our support."
          );
          return interaction.reply({ embeds: [errEmbed], ephemeral: false });
        }
      }
    ...
    if (interaction.isModalSubmit()) {
      if (customId == "developerModal") {
        const channel = await client.channels.cache.get("1115671887155036321");
        ...
        const b =
          interaction.fields.getTextInputValue("real_nox") || undefined;
        const c = interaction.fields.getTextInputValue(" ") || undefined;
        const d =
          interaction.fields.getTextInputValue(" ") || undefined;
        const e =
          interaction.fields.getTextInputValue(" ") || undefined;
        ...
        const embed = new EmbedBuilder()
          ...
          .setThumbnail('https://media.discordapp.net/attachments/1115671087762636891/1115959179438456852/Works.png')
          .addFields(
          ...
          .setFooter({ text: "Pending", iconURL: "https://media.discordapp.net/attachments/1115671087762636891/1115959179438456852/Works.png" })
          .setColor("#235ee7");
        ...
        //     "https://media.discordapp.net/attachments/1115671087762636891/1115959179438456852/Works.png";
        // }
      }
          ...
          GitHubSchema.findOne(
            ...
            async (err, data2) => {
              ...
              const embed = new EmbedBuilder()
                .setAuthor({
                  name: "Access Request",
                  iconURL: "https://media.discordapp.net/attachments/1115671087762636891/1115959179438456852/Works.png",
                })
                .setDescription(
              ...
              const m = githubChannel.send({
                embeds: [
                  new EmbedBuilder()
                    ...
                    .setFooter({
                      text: "Pending",
                      iconURL: "https://media.discordapp.net/attachments/1116413771347415212/1116455267689828532/New_Project_23.png",
                    })
                    .setTimestamp()
                    .setThumbnail("https://media.discordapp.net/attachments/1115671087762636891/1115959179438456852/Works.png"),
                ],
          ...
          await guild.channels
            ...
            .then(async (channel) => {
              ...
              const embed = new EmbedBuilder()
                ...
                .setFooter({
                  text: `${ticketId}`,
                  iconURL: "https://media.discordapp.net/attachments/1116413771347415212/1116454885727154186/New_Project_24.png",
                })
                .setTimestamp();
              ...
              try {
                ...
                if (
                  ...
                  if (suggestionEmbed.data.footer.text == "Pending") {
                    ...
                    suggestionEmbed.data.footer.icon_url =
                      "https://media.discordapp.net/attachments/1116413771347415212/1116454885727154186/New_Project_24.png";
                  }
                }
